...
import { Pokemon, Type, typesFromUserInput } from "../util/data-types";
import { formatMonsterNumber } from "../util/formatMonsterNumber";
import { MonsterImage } from "../unsorted/MonsterImage";
import { MonsterType } from "../unsorted/MonsterType";
import { Paginator } from "../unsorted/Paginator";
import { pickTranslation } from "../util/pickTranslation";
import { Search } from "../unsorted/Search";
import { StatsTable } from "../unsorted/StatsTable";
import { useComputedLanguage } from "../use/useComputedLanguage";
import { useSearch } from "../use/useSearch";
import { IconSparkles } from "../ui/IconSparkles";
import styles from "../../css/ScreenPokedex.module.css";
